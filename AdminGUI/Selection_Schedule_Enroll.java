   ...
   public Selection_Schedule_Enroll(Protocol p_t, ObjectOutputStream writer_t, ObjectInputStream reader_t, Socket sk) {
      ...
      btnNewButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            ...
            {		//게시일이 종료일보다 늦거나 게시일, 종료일이 8자리가 아닌경우 선발일정을 등록하지 않는다.
               ...
               try {
                  ...
                  if (p.getSubType() == 2) {	//선발일정 등록 결과 수신
                     if (p.getCode() == 1) {
                        JOptionPane.showMessageDialog(null, "선발일정이 정상적으로 등록되었습니다.");
                        dispose();
                     } else if (p.getCode() == 2) {		//날짜양식이 잘못됐거나 기타 에러
      ...
      textField_1 = new JTextField(""); // 게시일을 적을 수 있는 칸. 8자리로 작성 (ex) 20191215)
      ...
      textField_3 = new JTextField(""); // 종료일을 적을 수 있는 칸. 게시일과 작성규칙 동일
