...
public class Dormitory_cost  implements Serializable{
	...
	private String kind_code;				//생활관분류코드		1,2,3,
	private int mng_cost1;					//관리비_1학기			
	private int mng_cost2;					//관리비_하계방학
	private int mng_cost3;					//관리비_2학기
	private int mng_cost4;					//관리비_동계방학
	private int fd_food_cost1;				//5일식비_1학기
	private int fd_food_cost2;				//5일식비_하계방학
	private int fd_food_cost3;				//5일식비_2학기
	private int fd_food_cost4;				//5일식비_동계방학
	private int sd_food_cost1;				//7일식비_1학기
	private int sd_food_cost2;				//7일식비_하계방학
	private int sd_food_cost3;				//7일식비_2학기
	private int sd_food_cost4;				//7일식비_동계방학
